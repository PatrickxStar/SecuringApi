...
public class JwtTokenGenerator {
    ...
    // Correctly using @Value annotation to inject the secret key from application properties or environment variables
    @Value("${jwt.secret-key:default-fallback-secret-key}")
